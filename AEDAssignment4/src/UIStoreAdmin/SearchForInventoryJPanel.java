 ...
 */
public class SearchForInventoryJPanel extends javax.swing.JPanel {

    JPanel userProcessContainer;
    Store store;
    public SearchForInventoryJPanel(JPanel upc, Store s) {
        initComponents();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try{
        InventoryItem i;
        int inventoryId = Integer.parseInt(txtId.getText());
        i = store.getInventory().searchInventory(inventoryId);
        if(i!=null){
        SearchResultJPanel vpdjp = new SearchResultJPanel(userProcessContainer, i);
