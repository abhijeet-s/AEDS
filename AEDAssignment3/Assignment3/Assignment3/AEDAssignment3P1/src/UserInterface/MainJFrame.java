...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void btnAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdminActionPerformed
       AdminWorkAreaJPanel adminPanel = new AdminWorkAreaJPanel(supplierDirectory, userProcessContainer);
    ...
    private void btnSupplierManagerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupplierManagerActionPerformed
       LoginSupplier ls = new LoginSupplier(supplierDirectory, userProcessContainer);
       userProcessContainer.add("Login",ls);
       CardLayout layout = (CardLayout) userProcessContainer.getLayout();
       layout.next(userProcessContainer);     
