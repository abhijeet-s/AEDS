...
public class CreatePatientPerson extends javax.swing.JPanel {

    /**
     * Creates new form CreatePatientPerson
     */
    private PersonDirectory personDirectory;
    private JPanel userProcessContainer;
    public CreatePatientPerson(PersonDirectory personDirectory,JPanel userProcessContainer) {
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String FS =toUpperCase(txtFirstName.getText().trim());
        String LS = toUpperCase(txtLastName.getText().trim());
        
        try {
            int i ;
            i = ( FS.length()*LS.length()*txtSSN.getText().trim().length()*PI.length()*txtAge.getText().trim().length()* PD.length()*PP.length());
            if ( i==0)
            {
        ...
        if (personDirectory.checkPerson(SSN)){
                Exception e = new Exception("SSN already Exist.");
                throw(e);
            }
